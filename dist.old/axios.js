// Axios v0.0.1 Copyright (c) 2023 Matt Zabriskie and contributors
(function (global, factory) {
  ...
  function dispatchFetch(config, resolve, reject) {
    ...
    debugLog("request: ".concat(method, " ").concat(parsedUrl ? parsedUrl.toString() : fullPath, " (has bodys: ").concat(body, ") ").concat(config));
...
//# sourceMappingURL=https://axios.elide.dev/axios/0.0.1/axios.js.map
