...
function dispatchFetch(config, resolve, reject) {
  ...
  debugLog(`request: ${method} ${parsedUrl ? parsedUrl.toString() : fullPath} (has bodys: ${body}) ${config}`, config);
...
//# sourceMappingURL=https://axios.elide.dev/axios/0.0.1/esm/axios.js.map
